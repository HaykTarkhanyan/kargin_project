...
export const CHANGELOG: ChangelogEntry[] = [
  {
    ...
    items: [
      {
        icon: "🗂️",
        text: "Նոր բաժին՝ ձեռքով հավաքված խմբեր ըստ իրավիճակի՝ թուղթ խաղում են, հեռուստացույցի առաջ, բժշկի մոտ, ճանապարհային ոստիկանը։ Սքեթչի էջում երևում է, թե որ հավաքածուներում է նա",
      },
    ],
  },
  {
    ...
    items: [
      {
        icon: "🎯",
        text: "Քուիզը դարձավ իսկական թեստ՝ չորս մակարդակ, 10-ական հարց սքեթչների կադրերով ու խոսքերով, ֆան-թեստերի ոճով։ Ստուգելուց հետո ամեն հարցից հղում կա սքեթչին",
      },
    ],
  },
  {
