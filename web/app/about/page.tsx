...
export default function About() {
  ...
  const withSimilar = ALL.filter((s) => s.similar?.length).length;
  ...
  return (
    <main className="mx-auto max-w-2xl px-4 py-10 sm:px-8 sm:py-14">
      ...
      <Stage n="6" title="«Նմանատիպ» — gemini-embedding-2">
        ...
        նմանությունը հաշվվել է կոսինուսով։ Ցուցադրվում են միայն 0.75-ից բարձր գնահատականները,
        այդ պատճառով {withSimilar} սքեթչ ունի «նմանատիպ», մնացածի համար արխիվում պարզապես
        զույգ չկա։ Ստուգումը՝ ձայնային մատնահետքով գտնված 23 կրկնօրինակից 23-ը այս մեթոդով
        նույնպես առաջին տեղում են, թեև վեկտորը ձայնը երբեք չի լսել։
      </Stage>
